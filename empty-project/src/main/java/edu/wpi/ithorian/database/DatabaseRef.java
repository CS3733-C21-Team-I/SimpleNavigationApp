...
public class DatabaseRef {
    ...
    private DatabaseRef(String url) {
        ...
        try {
            ...
            //TODO logging error incorect URL
            connection = null;
        }
    }

    /**
     * Disconnect this DatabaseRef from the relevant Apache Database
     * Closing the connection, should be called prior to deconstruction
     */
    ...
    /**
     * HashMap containing all current open DatabaseRefs
     * Used to prevent attempting to connect to the same database twice
     */
