...
public class TextDirections {
	...
	public static double getCenterX() {
		return DirectionStep.calcCenterPointX(directionSteps.get(0).getPointA(), directionSteps.get(directionSteps.size()).getPointB());
	}

	public static double getCenterY() {
		return DirectionStep.calcCenterPointY(directionSteps.get(0).getPointA(), directionSteps.get(directionSteps.size()).getPointB());
	}

	public static double getWidth() {
		return DirectionStep.calcWidth(directionSteps.get(0).getPointA(), directionSteps.get(directionSteps.size()).getPointB());
	}

	public static double getHeight() {
		return DirectionStep.calcHeight(directionSteps.get(0).getPointA(), directionSteps.get(directionSteps.size()).getPointB());
	}
