...
import edu.wpi.cs3733.c21.teamI.ticket.EmployeeParkingTicket;
...
public class PermitRequestController {
    ...
    public void submit(ActionEvent e) {
        ...
        ParkingPeripheralServerManager.getInstance().requestStaffPermit(ApplicationDataController.getInstance().getLoggedInUser(), licensePlateTextfield.getText(), contactNumTextfield.getText(), new java.sql.Date(date.getTime()));
    ...
    private void refreshCurrentPermit() {
        StaffPermit ticket = ParkingPeripheralServerManager.getInstance().getStaffPermitForUser(ApplicationDataController.getInstance().getLoggedInUser());
